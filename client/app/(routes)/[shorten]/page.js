...
export default function Shorten() {
  ...
  return (
    <div className="w-full h-full pt-4 flex justify-center items-center">
      <div className="w-[400px] sm:w-[450px] md:w-[500px] lg:w-[700px] aspect-[5/3] flex flex-col gap-5 sm:gap-8 items-center justify-center bg-accent drop-shadow-lg rounded-xl ">
